	...
	if (isset($_GET['id'])) {
		...
		if ($get_order_info_res->num_rows < 1) {
			...
			$display_block .= <<<END_OF_TEXT
					...
					<ul>
						<li><label for="first-name">First Name: </label><input type="text" id="first-name" name="first-name" required></li>
						<li><label for="last-name">Last Name: </label><input type="text" id="last-name" name="last-name" required></li>
						...
						<li><label for="state">State: </label><input type="text" id="state" name="state" required></li>
						<li><label for="postcode">Postcode: </label><input type="text" id="postcode" name="postcode" required></li>
						<li><label for="tel">Telephone: </label><input type="text" id="tel" name="tel" required></li>
						<li><label for="email">Email: </label><input type="text" id="email" name="email" required></li>
